...
public class BluetoothConnections {
    ...
    public com.dantsu.escposprinter_encoding.connection.bluetooth.BluetoothConnection[] getList() {
        ...
        com.dantsu.escposprinter_encoding.connection.bluetooth.BluetoothConnection[] bluetoothDevices = new com.dantsu.escposprinter_encoding.connection.bluetooth.BluetoothConnection[bluetoothDevicesList.size()];
