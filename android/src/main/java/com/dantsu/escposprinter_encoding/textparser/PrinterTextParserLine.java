...
public class PrinterTextParserLine {
    private com.dantsu.escposprinter_encoding.textparser.PrinterTextParser textParser;
    ...
    public PrinterTextParserLine(com.dantsu.escposprinter_encoding.textparser.PrinterTextParser textParser, String textLine) throws EscPosParserException, EscPosBarcodeException, EscPosEncodingException {
        this.textParser = textParser;
        int nbrCharactersPerLine = this.getTextParser().getPrinter().getPrinterNbrCharactersPerLine();

        Pattern pattern = Pattern.compile(com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.getRegexAlignTags());
