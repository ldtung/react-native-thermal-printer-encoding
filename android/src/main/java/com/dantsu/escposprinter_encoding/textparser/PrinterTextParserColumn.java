...
import com.dantsu.escposprinter_encoding.textparser.IPrinterTextParserElement;
import com.dantsu.escposprinter_encoding.textparser.PrinterTextParser;
import com.dantsu.escposprinter_encoding.textparser.PrinterTextParserBarcode;
import com.dantsu.escposprinter_encoding.textparser.PrinterTextParserImg;
import com.dantsu.escposprinter_encoding.textparser.PrinterTextParserLine;
import com.dantsu.escposprinter_encoding.textparser.PrinterTextParserQRCode;
import com.dantsu.escposprinter_encoding.textparser.PrinterTextParserString;
import com.dantsu.escposprinter_encoding.textparser.PrinterTextParserTag;
...
public class PrinterTextParserColumn {
    ...
    private com.dantsu.escposprinter_encoding.textparser.PrinterTextParserLine textParserLine;
     ...
     */
    public PrinterTextParserColumn(com.dantsu.escposprinter_encoding.textparser.PrinterTextParserLine textParserLine, String textColumn) throws EscPosParserException, EscPosBarcodeException, EscPosEncodingException {
        this.textParserLine = textParserLine;
        com.dantsu.escposprinter_encoding.textparser.PrinterTextParser textParser = this.textParserLine.getTextParser();
        String textAlign = com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.TAGS_ALIGN_LEFT;
        byte[]
        ...
        if(textColumn.length() > 2) {
            switch (textColumn.substring(0, 3).toUpperCase()) {
                case "[" + com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.TAGS_ALIGN_LEFT + "]":
                case "[" + com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.TAGS_ALIGN_CENTER + "]":
                case "[" + com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.TAGS_ALIGN_RIGHT + "]":
        ...
        if (this.textParserLine.getNbrColumns() == 1 && trimmedTextColumn.indexOf("<") == 0) {
            ...
            if (openTagIndex < openTagEndIndex) {
                com.dantsu.escposprinter_encoding.textparser.PrinterTextParserTag textParserTag = new com.dantsu.escposprinter_encoding.textparser.PrinterTextParserTag(trimmedTextColumn.substring(openTagIndex, openTagEndIndex));

                switch (textParserTag.getTagName()) {
                    case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.TAGS_IMAGE:
                    case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.TAGS_BARCODE:
                    case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.TAGS_QRCODE:
        ...
        if (!isImgOrBarcodeLine) {
            ...
            while (true) {
                ...
                closeTagIndex++;
                com.dantsu.escposprinter_encoding.textparser.PrinterTextParserTag textParserTag = new PrinterTextParserTag(textColumn.substring(openTagIndex, closeTagIndex));

                if (com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.isTagTextFormat(textParserTag.getTagName())) {
                    if (textParserTag.isCloseTag()) {
                        switch (textParserTag.getTagName()) {
                            case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.TAGS_FORMAT_TEXT_BOLD:
                                textParser.dropTextBold();
                                break;
                            case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.TAGS_FORMAT_TEXT_UNDERLINE:
                                textParser.dropLastTextUnderline();
                                textParser.dropLastTextDoubleStrike();
                                break;
                            case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.TAGS_FORMAT_TEXT_FONT:
                        ...
                        switch (textParserTag.getTagName()) {
                            case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.TAGS_FORMAT_TEXT_BOLD:
                                ...
                                break;
                            case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.TAGS_FORMAT_TEXT_UNDERLINE:
                                if (textParserTag.hasAttribute(com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_UNDERLINE_TYPE)) {
                                    switch (textParserTag.getAttribute(com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_UNDERLINE_TYPE)) {
                                        case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_UNDERLINE_TYPE_NORMAL:
                                            ...
                                            break;
                                        case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_UNDERLINE_TYPE_DOUBLE:
                                ...
                                break;
                            case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.TAGS_FORMAT_TEXT_FONT:
                                if (textParserTag.hasAttribute(com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_SIZE)) {
                                    switch (textParserTag.getAttribute(com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_SIZE)) {
                                        case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_SIZE_NORMAL:
                                        default:
                                            textParser.addTextSize(EscPosPrinterCommands.TEXT_SIZE_NORMAL);
                                            break;
                                        case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_SIZE_TALL:
                                            textParser.addTextSize(EscPosPrinterCommands.TEXT_SIZE_DOUBLE_HEIGHT);
                                            break;
                                        case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_SIZE_WIDE:
                                            textParser.addTextSize(EscPosPrinterCommands.TEXT_SIZE_DOUBLE_WIDTH);
                                            break;
                                        case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_SIZE_BIG:
                                            textParser.addTextSize(EscPosPrinterCommands.TEXT_SIZE_BIG);
                                            break;
                                        case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_SIZE_BIG_2:
                                            textParser.addTextSize(EscPosPrinterCommands.TEXT_SIZE_BIG_2);
                                            break;
                                        case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_SIZE_BIG_3:
                                            textParser.addTextSize(EscPosPrinterCommands.TEXT_SIZE_BIG_3);
                                            break;
                                        case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_SIZE_BIG_4:
                                            textParser.addTextSize(EscPosPrinterCommands.TEXT_SIZE_BIG_4);
                                            break;
                                        case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_SIZE_BIG_5:
                                            textParser.addTextSize(EscPosPrinterCommands.TEXT_SIZE_BIG_5);
                                            break;
                                        case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_SIZE_BIG_6:
                                ...
                                if (textParserTag.hasAttribute(com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_COLOR)) {
                                    switch (textParserTag.getAttribute(com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_COLOR)) {
                                        case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_COLOR_BLACK:
                                        default:
                                            ...
                                            break;
                                        case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_COLOR_BG_BLACK:
                                            textParser.addTextColor(EscPosPrinterCommands.TEXT_COLOR_BLACK);
                                            textParser.addTextReverseColor(EscPosPrinterCommands.TEXT_COLOR_REVERSE_ON);
                                            break;
                                        case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_COLOR_RED:
                                            textParser.addTextColor(EscPosPrinterCommands.TEXT_COLOR_RED);
                                            textParser.addTextReverseColor(EscPosPrinterCommands.TEXT_COLOR_REVERSE_OFF);
                                            break;
                                        case com.dantsu.escposprinter_encoding.textparser.PrinterTextParser.ATTR_FORMAT_TEXT_FONT_COLOR_BG_RED:
                                            textParser.addTextColor(EscPosPrinterCommands.TEXT_COLOR_RED);
                                            textParser.addTextReverseColor(EscPosPrinterCommands.TEXT_COLOR_REVERSE_ON);
                                            break;
                                    }
    ...
    private PrinterTextParserColumn prependImage(String textAlign, String hexString) {
        return this.prependElement(new com.dantsu.escposprinter_encoding.textparser.PrinterTextParserImg(this, textAlign, hexString));
    }
